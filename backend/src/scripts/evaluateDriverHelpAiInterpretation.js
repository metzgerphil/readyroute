  ...
  async function worker() {
    while (nextIndex < cases.length) {
      ...
      try {
        ...
        const expectedResponseMode = expectedDecision(testCase);
        results[index] = {
          ...
          record_match: Boolean(interpretation && expectedKnowledgeIds.includes(interpretation.knowledge_id)),
          response_mode_match: interpretation?.decision === expectedResponseMode,
          valid_result: Boolean(interpretation),
