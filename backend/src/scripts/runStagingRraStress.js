...
const CASES = [
  ...
  ['VLAD_BUSINESS_CLOSED', "I knocked and nobody answered at this business. It's locked up, what do I do with the package?", 'ANSWER', 'KNO-DEL-BUS-CLOSED-001', 'Use Code 011 for an applicable weekend closure or Code 004 otherwise. Complete the door tag, cross the package, remove the SID, and return it to the station.'],
  ...
  ['VLAD_BIZ_CLOSED', 'biz closed', 'ANSWER', 'KNO-DEL-BUS-CLOSED-001', 'Use Code 011 for an applicable weekend closure or Code 004 otherwise. Complete the door tag, cross the package, remove the SID, and return it to the station.'],
