...
- A separate idempotent $10 driver/calendar-month ledger is prepared. Driver creation/activation accrues one row per month; same-month deactivation/reactivation cannot duplicate it; a monthly function accrues active drivers for a new month. It does not issue Stripe charges.
