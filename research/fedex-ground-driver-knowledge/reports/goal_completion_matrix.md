...
| Investigate sources producing unexpectedly little knowledge | Achieved for current fully reviewed set | `validation/fully_reviewed_source_sparsity_audit.md` plus dedicated review artifacts for all 75 fully/partially reviewed primary sources. | Child-source families and transient-source recapture remain open. |
