...
def build_rows() -> list[dict[str, str]]:
    ...
    explicit = {
        ...
        123: ("UI_SCREEN_REFERENCE", "Intermediate call-tag Pickup selection and listed-stop dropdown screens; the generic unlisted-pickup procedure is established by current OP-117 and its mapped FORGE workflow."),
        124: ("UI_SCREEN_REFERENCE", "Intermediate call-tag listed-stop assignment and Not On List branch screens; the generic branch is established by the mapped unlisted-pickup procedure."),
        125: ("UI_SCREEN_REFERENCE", "Intermediate call-tag address-entry and action-menu screens; the page adds no independent rule beyond the mapped unlisted-pickup and call-tag action-scope procedures."),
        128: ("UI_SCREEN_REFERENCE", "Blank continuation page within the call-tag walkthrough; no independent procedure."),
        129: ("UI_SCREEN_REFERENCE", "Intermediate call-tag stop-type and close-control screens; the generic stop classification and close mechanics are established by mapped pickup procedures."),
        130: ("UI_SCREEN_REFERENCE", "Intermediate call-tag close-summary and Non-Delivered Package screens; the page adds no independent outcome rule beyond the mapped call-tag procedures."),
