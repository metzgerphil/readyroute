...
Rows without a current queue link remain explicit acquisition obligations. This does not establish that they are unavailable in MyGroundBiz. It proves only that the present 266-resource queue does not yet contain an evidence-backed link to them.
