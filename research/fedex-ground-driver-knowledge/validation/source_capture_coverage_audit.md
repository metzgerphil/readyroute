...
All 89 fully or partially reviewed primary sources have a source-specific review artifact. Seventy-seven of the 121 primary-source records resolve to durable, checksum-protected local source bytes; four byte-identical portal/Drive pairs share archive paths within the 69-entry checksum manifest. Eleven reviewed or partially reviewed MyGroundBiz sources lack original source-byte archives: two have complete hashed page renders, two have partial hashed page renders, five have only transient full-review artifacts, and two remain transient-partial. The sixth transient full-review row is the Drive connector folder container; its 35 current child files are independently raw-byte hashed and reconciled to 31 existing registered archive objects. Six additional MyGroundBiz videos have durable bytes and complete source-specific audio-visual reviews; they are retained as historical context without operational extraction.
